...
Public Class rptAllYearDuesDR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptAllYearDuesDR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAllYearDuesDR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAllYearDuesDR = New rptAllYearDuesDR()
        rpt.Site = Me.Site
        Return rpt
    End Function
