...
Public Class rptReAdmission
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptReAdmission.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReAdmission
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReAdmission = New rptReAdmission()
        rpt.Site = Me.Site
        Return rpt
    End Function
