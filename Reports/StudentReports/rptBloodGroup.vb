...
Public Class rptBloodGroup
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptBloodGroup.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBloodGroup
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBloodGroup = New rptBloodGroup()
        rpt.Site = Me.Site
        Return rpt
    End Function
