...
Public Class rptStudentReligion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptStudentReligion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStudentReligion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStudentReligion = New rptStudentReligion()
        rpt.Site = Me.Site
        Return rpt
    End Function
