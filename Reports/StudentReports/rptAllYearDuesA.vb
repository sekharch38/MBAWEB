...
Public Class rptAllYearDuesA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptAllYearDuesA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAllYearDuesA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAllYearDuesA = New rptAllYearDuesA()
        rpt.Site = Me.Site
        Return rpt
    End Function
