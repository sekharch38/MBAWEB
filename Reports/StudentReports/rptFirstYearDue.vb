...
Public Class rptFirstYearDue
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptFirstYearDue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFirstYearDue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFirstYearDue = New rptFirstYearDue()
        rpt.Site = Me.Site
        Return rpt
    End Function
