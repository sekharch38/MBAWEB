...
Public Class rptStudentDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptStudentDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStudentDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStudentDetails = New rptStudentDetails
        rpt.Site = Me.Site
        Return rpt
    End Function
