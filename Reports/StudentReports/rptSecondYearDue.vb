...
Public Class rptSecondYearDue
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptSecondYearDue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSecondYearDue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSecondYearDue = New rptSecondYearDue()
        rpt.Site = Me.Site
        Return rpt
    End Function
