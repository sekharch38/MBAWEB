...
Public Class rptUFROBonafide
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptUFROBonafide.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptUFROBonafide
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptUFROBonafide = New rptUFROBonafide()
        rpt.Site = Me.Site
        Return rpt
    End Function
