...
Public Class rptAllYearDues
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptAllYearDues.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAllYearDues
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAllYearDues = New rptAllYearDues()
        rpt.Site = Me.Site
        Return rpt
    End Function
