...
Public Class rptFourthYearDue
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptFourthYearDue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFourthYearDue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFourthYearDue = New rptFourthYearDue()
        rpt.Site = Me.Site
        Return rpt
    End Function
