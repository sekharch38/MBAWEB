...
Public Class rptStudentLanguages
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStudentLanguages.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptStudentLanguages.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStudentLanguages
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStudentLanguages = New rptStudentLanguages()
        rpt.Site = Me.Site
        Return rpt
    End Function
