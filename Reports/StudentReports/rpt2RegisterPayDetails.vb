...
Public Class rpt2RegisterPayDetails
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt2RegisterPayDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rpt2RegisterPayDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt2RegisterPayDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt2RegisterPayDetails = New rpt2RegisterPayDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
