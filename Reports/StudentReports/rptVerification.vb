...
Public Class rptVerification
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptVerification.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVerification
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVerification = New rptVerification()
        rpt.Site = Me.Site
        Return rpt
    End Function
