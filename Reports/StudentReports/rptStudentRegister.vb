...
Public Class rptStudentRegister
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptStudentRegister.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStudentRegister
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStudentRegister = New rptStudentRegister()
        rpt.Site = Me.Site
        Return rpt
    End Function
