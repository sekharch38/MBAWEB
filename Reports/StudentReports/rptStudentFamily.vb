...
Public Class rptStudentFamily
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptStudentFamily.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStudentFamily
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStudentFamily = New rptStudentFamily
        rpt.Site = Me.Site
        Return rpt
    End Function
