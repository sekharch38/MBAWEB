...
Public Class rptStudentYearGraph
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStudentYearGraph.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptStudentYearGraph.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStudentYearGraph
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStudentYearGraph = New rptStudentYearGraph()
        rpt.Site = Me.Site
        Return rpt
    End Function
