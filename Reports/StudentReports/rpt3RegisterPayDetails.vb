...
Public Class rpt3RegisterPayDetails
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt3RegisterPayDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rpt3RegisterPayDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt3RegisterPayDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt3RegisterPayDetails = New rpt3RegisterPayDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
