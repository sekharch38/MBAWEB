...
Public Class rptBonafidemba
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptBonafidemba.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBonafidemba
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBonafidemba = New rptBonafidemba()
        rpt.Site = Me.Site
        Return rpt
    End Function
