...
Public Class rptSRConsolidate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptSRConsolidate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSRConsolidate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSRConsolidate = New rptSRConsolidate()
        rpt.Site = Me.Site
        Return rpt
    End Function
