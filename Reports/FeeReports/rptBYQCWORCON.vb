...
Public Class rptBYQCWORCON
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptBYQCWORCON.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBYQCWORCON
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBYQCWORCON = New rptBYQCWORCON()
        rpt.Site = Me.Site
        Return rpt
    End Function
