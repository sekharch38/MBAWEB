...
Public Class ChartMEProgram
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.ChartMEProgram.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChartMEProgram
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChartMEProgram = New ChartMEProgram()
        rpt.Site = Me.Site
        Return rpt
    End Function
