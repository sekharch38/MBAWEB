...
Public Class rptOpeningBalance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptOpeningBalance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOpeningBalance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOpeningBalance = New rptOpeningBalance()
        rpt.Site = Me.Site
        Return rpt
    End Function
