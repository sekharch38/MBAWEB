...
Public Class rptStudentTotal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptStudentTotal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStudentTotal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStudentTotal = New rptStudentTotal()
        rpt.Site = Me.Site
        Return rpt
    End Function
