...
Public Class rptYearCourse
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptYearCourse.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptYearCourse
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptYearCourse = New rptYearCourse()
        rpt.Site = Me.Site
        Return rpt
    End Function
