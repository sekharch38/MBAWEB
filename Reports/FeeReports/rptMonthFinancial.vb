...
Public Class rptMonthFinancial
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptMonthFinancial.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMonthFinancial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMonthFinancial = New rptMonthFinancial()
        rpt.Site = Me.Site
        Return rpt
    End Function
