...
Public Class rptBYQCCONCAT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptBYQCCONCAT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBYQCCONCAT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBYQCCONCAT = New rptBYQCCONCAT()
        rpt.Site = Me.Site
        Return rpt
    End Function
