...
Public Class rptBYQCTFRACON
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptBYQCTFRACON.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBYQCTFRACON
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBYQCTFRACON = New rptBYQCTFRACON()
        rpt.Site = Me.Site
        Return rpt
    End Function
