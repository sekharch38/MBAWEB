...
Public Class rptStudentPayable
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptStudentPayable.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStudentPayable
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStudentPayable = New rptStudentPayable()
        rpt.Site = Me.Site
        Return rpt
    End Function
