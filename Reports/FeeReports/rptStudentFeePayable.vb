...
Public Class rptStudentFeePayable
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStudentFeePayable.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptStudentFeePayable.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStudentFeePayable
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStudentFeePayable = New rptStudentFeePayable()
        rpt.Site = Me.Site
        Return rpt
    End Function
