...
Public Class rptStudentRefund
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptStudentRefund.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStudentRefund
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStudentRefund = New rptStudentRefund()
        rpt.Site = Me.Site
        Return rpt
    End Function
