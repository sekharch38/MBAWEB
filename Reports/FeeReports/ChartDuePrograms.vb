...
Public Class ChartDuePrograms
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.ChartDuePrograms.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChartDuePrograms
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChartDuePrograms = New ChartDuePrograms()
        rpt.Site = Me.Site
        Return rpt
    End Function
