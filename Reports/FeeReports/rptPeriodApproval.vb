...
Public Class rptPeriodApproval
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptPeriodApproval.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPeriodApproval
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPeriodApproval = New rptPeriodApproval()
        rpt.Site = Me.Site
        Return rpt
    End Function
