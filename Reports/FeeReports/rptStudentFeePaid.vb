...
Public Class rptStudentFeePaid
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptStudentFeePaid.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStudentFeePaid
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStudentFeePaid = New rptStudentFeePaid()
        rpt.Site = Me.Site
        Return rpt
    End Function
