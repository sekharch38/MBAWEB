...
Public Class rptToBeRefund
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptToBeRefund.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptToBeRefund
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptToBeRefund = New rptToBeRefund()
        rpt.Site = Me.Site
        Return rpt
    End Function
