...
Public Class rptStudentDues
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptStudentDues.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStudentDues
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStudentDues = New rptStudentDues()
        rpt.Site = Me.Site
        Return rpt
    End Function
