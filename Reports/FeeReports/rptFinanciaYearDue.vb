...
Public Class rptFinanciaYearDue
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptFinanciaYearDue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFinanciaYearDue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFinanciaYearDue = New rptFinanciaYearDue()
        rpt.Site = Me.Site
        Return rpt
    End Function
