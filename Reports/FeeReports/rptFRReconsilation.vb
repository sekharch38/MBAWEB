...
Public Class rptFRReconsilation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptFRReconsilation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFRReconsilation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFRReconsilation = New rptFRReconsilation()
        rpt.Site = Me.Site
        Return rpt
    End Function
