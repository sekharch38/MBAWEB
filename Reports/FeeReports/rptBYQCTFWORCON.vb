...
Public Class rptBYQCTFWORCON
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptBYQCTFWORCON.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBYQCTFWORCON
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBYQCTFWORCON = New rptBYQCTFWORCON()
        rpt.Site = Me.Site
        Return rpt
    End Function
