...
Public Class rptModifiedList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptModifiedList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptModifiedList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptModifiedList = New rptModifiedList()
        rpt.Site = Me.Site
        Return rpt
    End Function
