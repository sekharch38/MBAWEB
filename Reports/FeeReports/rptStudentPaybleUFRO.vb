...
Public Class rptStudentPaybleUFRO
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStudentPaybleUFRO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptStudentPaybleUFRO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStudentPaybleUFRO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStudentPaybleUFRO = New rptStudentPaybleUFRO()
        rpt.Site = Me.Site
        Return rpt
    End Function
