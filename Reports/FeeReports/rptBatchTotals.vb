...
Public Class rptBatchTotals
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptBatchTotals.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_RepName() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptBatchTotals
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBatchTotals = New rptBatchTotals()
        rpt.Site = Me.Site
        Return rpt
    End Function
