...
Public Class rptAllQuotaSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptAllQuotaSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAllQuotaSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAllQuotaSummary = New rptAllQuotaSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
