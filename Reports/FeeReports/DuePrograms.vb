...
Public Class DuePrograms
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.DuePrograms.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ChartDueProgramsrpt_UserName() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedDuePrograms
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DuePrograms = New DuePrograms()
        rpt.Site = Me.Site
        Return rpt
    End Function
