...
Public Class rptStudentSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptStudentSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStudentSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStudentSummary = New rptStudentSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
