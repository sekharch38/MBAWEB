...
Public Class rptBatchOATCCon
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptBatchOATCCon.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBatchOATCCon
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBatchOATCCon = New rptBatchOATCCon()
        rpt.Site = Me.Site
        Return rpt
    End Function
