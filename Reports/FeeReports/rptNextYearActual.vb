...
Public Class rptNextYearActual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptNextYearActual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNextYearActual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNextYearActual = New rptNextYearActual()
        rpt.Site = Me.Site
        Return rpt
    End Function
