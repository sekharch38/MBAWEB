...
Public Class rptBatchEntry
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptBatchEntry.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBatchEntry
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBatchEntry = New rptBatchEntry()
        rpt.Site = Me.Site
        Return rpt
    End Function
