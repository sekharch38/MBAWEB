...
Public Class rptFinancialQuota
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptFinancialQuota.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFinancialQuota
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFinancialQuota = New rptFinancialQuota()
        rpt.Site = Me.Site
        Return rpt
    End Function
