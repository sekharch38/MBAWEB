...
Public Class rptStudentPaid
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptStudentPaid.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStudentPaid
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStudentPaid = New rptStudentPaid()
        rpt.Site = Me.Site
        Return rpt
    End Function
