...
Public Class rptNextYearStudentTotal
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptNextYearStudentTotal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptNextYearStudentTotal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNextYearStudentTotal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNextYearStudentTotal = New rptNextYearStudentTotal()
        rpt.Site = Me.Site
        Return rpt
    End Function
