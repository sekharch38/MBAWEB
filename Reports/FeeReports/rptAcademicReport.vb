...
Public Class rptAcademicReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptAcademicReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAcademicReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAcademicReport = New rptAcademicReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
