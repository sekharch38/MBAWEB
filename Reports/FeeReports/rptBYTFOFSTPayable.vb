...
Public Class rptBYTFOFSTPayable
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptBYTFOFSTPayable.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBYTFOFSTPayable
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBYTFOFSTPayable = New rptBYTFOFSTPayable()
        rpt.Site = Me.Site
        Return rpt
    End Function
