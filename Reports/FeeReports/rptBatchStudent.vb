...
Public Class rptBatchStudent
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptBatchStudent.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBatchStudent
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBatchStudent = New rptBatchStudent()
        rpt.Site = Me.Site
        Return rpt
    End Function
