...
Public Class rptCourseSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptCourseSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCourseSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCourseSummary = New rptCourseSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
