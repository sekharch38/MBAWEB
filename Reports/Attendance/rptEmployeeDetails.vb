...
Public Class rptEmployeeDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptEmployeeDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEmployeeDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEmployeeDetails = New rptEmployeeDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
