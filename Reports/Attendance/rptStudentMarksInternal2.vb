...
Public Class rptStudentMarksInternal2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStudentMarksInternal2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptStudentMarksInternal2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStudentMarksInternal2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStudentMarksInternal2 = New rptStudentMarksInternal2()
        rpt.Site = Me.Site
        Return rpt
    End Function
