...
Public Class rptAttendanceSTGB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptAttendanceSTGB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAttendanceSTGB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAttendanceSTGB = New rptAttendanceSTGB()
        rpt.Site = Me.Site
        Return rpt
    End Function
