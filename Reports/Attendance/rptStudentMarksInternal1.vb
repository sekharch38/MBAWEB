...
Public Class rptStudentMarksInternal1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStudentMarksInternal1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptStudentMarksInternal1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStudentMarksInternal1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStudentMarksInternal1 = New rptStudentMarksInternal1()
        rpt.Site = Me.Site
        Return rpt
    End Function
