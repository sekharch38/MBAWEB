...
Public Class rptAttendanceSTGOB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptAttendanceSTGOB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAttendanceSTGOB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAttendanceSTGOB = New rptAttendanceSTGOB()
        rpt.Site = Me.Site
        Return rpt
    End Function
