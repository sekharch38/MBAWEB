...
Public Class rptAttendanceRegister
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptAttendanceRegister.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAttendanceRegister
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAttendanceRegister = New rptAttendanceRegister()
        rpt.Site = Me.Site
        Return rpt
    End Function
