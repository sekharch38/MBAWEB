...
Public Class rptStudentIdCard
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptStudentIdCard.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStudentIdCard
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStudentIdCard = New rptStudentIdCard()
        rpt.Site = Me.Site
        Return rpt
    End Function
