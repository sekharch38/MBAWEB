...
Public Class subjectrptWOS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.subjectrptWOS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedsubjectrptWOS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As subjectrptWOS = New subjectrptWOS()
        rpt.Site = Me.Site
        Return rpt
    End Function
