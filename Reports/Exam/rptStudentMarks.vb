...
Public Class rptStudentMarks
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptStudentMarks.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStudentMarks
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStudentMarks = New rptStudentMarks()
        rpt.Site = Me.Site
        Return rpt
    End Function
