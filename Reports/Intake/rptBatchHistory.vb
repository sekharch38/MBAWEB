...
Public Class rptBatchHistory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptBatchHistory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBatchHistory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBatchHistory = New rptBatchHistory()
        rpt.Site = Me.Site
        Return rpt
    End Function
