...
Public Class rptIntakeReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptIntakeReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIntakeReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIntakeReport = New rptIntakeReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
