...
Public Class rptBatchDocuements
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptBatchDocuements.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBatchDocuements
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBatchDocuements = New rptBatchDocuements()
        rpt.Site = Me.Site
        Return rpt
    End Function
