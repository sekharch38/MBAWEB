...
Public Class rptBatchAnalysis
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptBatchAnalysis.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBatchAnalysis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBatchAnalysis = New rptBatchAnalysis()
        rpt.Site = Me.Site
        Return rpt
    End Function
