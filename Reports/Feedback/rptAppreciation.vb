...
Public Class rptAppreciation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptAppreciation.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_AY() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptAppreciation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAppreciation = New rptAppreciation()
        rpt.Site = Me.Site
        Return rpt
    End Function
