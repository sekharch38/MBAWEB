...
Public Class rptFBAnalysis
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptFBAnalysis.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFBAnalysis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFBAnalysis = New rptFBAnalysis()
        rpt.Site = Me.Site
        Return rpt
    End Function
