...
Public Class rptExplanation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptExplanation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptExplanation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptExplanation = New rptExplanation()
        rpt.Site = Me.Site
        Return rpt
    End Function
