...
Public Class rptFBAnalysisWOR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reports.rptFBAnalysisWOR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFBAnalysisWOR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFBAnalysisWOR = New rptFBAnalysisWOR()
        rpt.Site = Me.Site
        Return rpt
    End Function
